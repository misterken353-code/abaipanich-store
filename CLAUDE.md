...
- **ยังไม่ได้ทำ (ถ้าต้องการต่อยอดจริงจังกว่านี้):** ระบบคะแนน/rating คนขับ, ค่าคอมมิชชั่น/payout, จับคู่ตามระยะทางอัตโนมัติ (ตอนนี้เป็น first-come-first-served ธรรมดา), ประวัติงานที่ส่งสำเร็จของคนขับ (ตอนนี้แค่หายจากหน้าจอ ไม่มีหน้า "ประวัติ" ให้ดูย้อนหลัง)
